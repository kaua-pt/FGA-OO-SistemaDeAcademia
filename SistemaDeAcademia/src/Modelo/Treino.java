 ...
 *         implementa a classe operacoes e herda elementos da classe BaseAcademia
 *         
 * @see BaseAcademia
 * @see Operacoes
 */
...
public class Treino extends BaseAcademia implements Operacoes {
	...
	public Treino(String nome, ArrayList<TipoDeGrupamento> tipo,
			ArrayList<Exercicio> exercicios, int nRepeticao,
			int nSerie) {
	...
	/**
	 * Sobrescrita do método toString que retorna todas 
	 * as informações do objeto treino
	 * 
	 * @return String
	 */
	@Override
	...
	/**
	 *Sobrescreve o método de cadastro vindo da interface operacao no qual: {@inheritDoc} 
	 *
	 ...
	 * o nome de cada elemento salvo, caso seja encontrado, será substituído 
	 * o elemento atual do loop pelo objeto em que foi chamado.É feito isso para
	 * dois banco de dados, o de treino e o de alunos.
	 * 
	 * @see BancoDeDados
	 */
	@Override
	 ...
	 * do loop será excluído.É feito isso paradois banco de dados, o de treino e 
	 * o de alunos.
	 * 
	 * @see BancoDeDados
	 */
	 ...
	 * 
	 * No método é percorrido cada elemento do banco de dados de treino
	 * e é comparado o nome de cada treino com a string nome, se for 
	 * encontrado, ele retorna o Objeto do treino procurado, caso não, 
	 * retorna null.
	 * 
	 ...
	 * 
	 * No método é utilizado um loop para percorrer cada elemento da 
	 * arraylist de tipos, então, é feito uma substring com esses elementos
	 * na qual é retornada sem o primiero caracter de vírgula.
	 * 
	 * @see ArrayList
	 * @return String
	 */
	...
	/**
	 * Retorna uma lista de Strings contendo o nome de todos os exercícios
	 * anexados ao presente treino.
	 * 
	 ...
	 * 
	 * No método é realizado um loop em  todo o Banco de dados de alunos,
	 * em que, para cada aluno é feito um outro loop em cima de seus treinos 
	 * com a finalidade de encontrar qual aluno está anexado ao atual treino.
	 * 
	 * @see BancoDeDados
	 * @return String
	 */
