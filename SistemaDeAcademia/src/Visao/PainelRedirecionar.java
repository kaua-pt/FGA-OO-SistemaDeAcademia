...
import Visao.PainelMenu.PanelAdaptador;
...
public class PainelRedirecionar extends JPanel {
	...
	public PainelRedirecionar(String operacao) {
		...
		lblCadastro.setIcon(
				new ImageIcon(Toolkit.getDefaultToolkit().getImage(PainelMenu.class.getResource("/Imagens/cadastro.png"))
						.getScaledInstance(40, 40, Image.SCALE_SMOOTH)));
		panel.add(lblCadastro);
		
		JLabel lblNewLabel_1 = new JLabel("Cadastrar " + this.operacao);
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setFont(new Font("Fira Code", Font.BOLD, 20));
		lblNewLabel_1.setBounds(0, 110, 218, 76);
		...
		lblCadastro_1.setIcon(
				new ImageIcon(Toolkit.getDefaultToolkit().getImage(PainelMenu.class.getResource("/Imagens/pesquisa-de-dados.png"))
						.getScaledInstance(40, 40, Image.SCALE_SMOOTH)));
		panel_1.add(lblCadastro_1);
		
		JLabel lblNewLabel_1_1 = new JLabel("Consultar "+ this.operacao);
		lblNewLabel_1_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1_1.setFont(new Font("Fira Code", Font.BOLD, 20));
