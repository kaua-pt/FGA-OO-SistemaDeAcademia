...
public class PanelCadastroTreino extends JPanel implements ActionListener {
	...
	/**
	 * Construtor que realiza a inicialização da tela
	 * 
	 * @see ControladorTelaCadastroTreino
	 */
	public PanelCadastroTreino() {
		// Defino as características base da tela
		...
		// Defino primeiro panel que aparecerá para o usuário
		...
		// Defino o botão para retornar para o cadastrar
		...
		// Defino a label para direcionar o usuário em relação ao nome
		...
		// Defino o label para direcionar usuário em relação ao aluno
		...
		// Defino o label para direcionar o usuário em relação ao tipo
		...
		// Defino o botão para mostrar a tela de exercícios
		...
		// Defino a label onde haverá o icone de nome
		...
		// Defino a label onde haverá o icone de aluno
		...
		// Defino a label onde haverá o icone de tipo
		...
		// Defino o panel onde ficará a segunda parte de informações principais
		...
		// Defino a label de ajuda para as séries
		...
		// Defino a lista onde estará os exercicios que devem ser selecionados
		...
		// Controlador que realiza a conecção entre o front e o backend
