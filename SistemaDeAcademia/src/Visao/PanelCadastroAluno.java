 ...
 * @author Kau√£ Vin√≠cius
 * 
 *         Classe em que √© implementado a tela para cadastro de aluno Herda a
...
public class PanelCadastroAluno extends JPanel implements ActionListener {
	...
	/**
	 * Construtor no qual cria a tela e suas dependÍncias AÁ„o dos botıes atrelado
	 * ao BackEnd
	 * 
	...
	public PanelCadastroAluno() {
		...
		// Defino o panel principal que È usado como base
		panel = new JPanel();
