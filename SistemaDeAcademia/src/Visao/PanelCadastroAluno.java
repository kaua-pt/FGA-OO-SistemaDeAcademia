 ...
 * 
 *         Classe em que Ã© implementado a tela para cadastro de aluno Herda a
...
public class PanelCadastroAluno extends JPanel implements ActionListener {
	...
	public PanelCadastroAluno() {
		...
		// Defino o onde é inserido o spin da idade
		...
		// Defino spin que absorverá a idade
		...
		// Defino o campo em que estará o titulo
		...
		// Defino o campo onde será colocado o spin de peso
		panelPeso = new JPanel();
		panelPeso.setLayout(null);
		panelPeso.setBounds(137, 270, 91, 47);
		panel.add(panelPeso);

		// Defino o spin onde será inserido peso do aluno
		...
		// Defino um panel para design da página
		faixa = new JPanel();
		faixa.setBackground(new Color(216, 205, 176));
		faixa.setBounds(0, 28, 529, 31);
		panel.add(faixa);

		// Defino o campo onde será colocado um texto de ajuda ao usuário em relação ao
		// nome
		...
		// Defino o campo onde será colocado um texto de ajuda ao usuário em relação a
		// idade
		...
		// Defino o botão para voltar ao início
		...
		// Defino o controlador da tela que realizará a ligação com o backend
